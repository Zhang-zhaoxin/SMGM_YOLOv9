...
from yolo9.model import preprocess_true_boxes, yolo4_body, yolo4_loss
from yolo9.utils import get_random_data
...
def _main():
    ...
    model = create_model(input_shape, anchors, num_classes,
        freeze_body=False, weights_path='yolo9_weights.h5') # make sure you know what you freeze
